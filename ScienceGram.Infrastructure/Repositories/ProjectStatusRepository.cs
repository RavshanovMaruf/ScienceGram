...
{
	public class ProjectStatusRepository : EfBaseRepository<ProjectStatus, ApplicationDbContext>, IProjectStatusRepository
	{
		public ProjectStatusRepository(ApplicationDbContext dbContext) : base(dbContext)
		{
		}
	}
}
